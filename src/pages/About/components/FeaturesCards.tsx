...
const cards = [
  {
    ...
    descriptionKey: 'about_feature_card.card_one.description',
  },
  {
    id: 'card-two',
    icon: IconType.File,
    titleKey: 'about_feature_card.card_two.title',
    descriptionKey: 'about_feature_card.card_two.description',
  },
  {
    id: 'card-three',
    icon: IconType.ArrowGuide,
    titleKey: 'about_feature_card.card_three.title',
    descriptionKey: 'about_feature_card.card_three.description',
  },
  {
    id: 'card-four',
    icon: IconType.BracketsAngle,
    titleKey: 'about_feature_card.card_four.title',
    descriptionKey: 'about_feature_card.card_four.description',
  },
];
